...
mv /install/chkconfig /sbin/chkconfig &&
chmod 755 /sbin/chkconfig &&

# Install Oracle
cat /install/oracle-xe_11.2.0-1.0_amd64.deba* > /install/oracle-xe_11.2.0-1.0_amd64.deb &&
dpkg --install /install/oracle-xe_11.2.0-1.0_amd64.deb &&
...
mv /install/init.ora /u01/app/oracle/product/11.2.0/xe/config/scripts &&
mv /install/initXETemp.ora /u01/app/oracle/product/11.2.0/xe/config/scripts &&
...
mv /install/startup.sh /usr/sbin/startup.sh &&
chmod +x /usr/sbin/startup.sh &&

# Create initialization script folders
mkdir /docker-oracle-scripts
